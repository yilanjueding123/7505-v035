...
INT32U reg_1byte_data_1byte_write(i2c_bus_handle_t * handle, 
	INT8U reg, 
	INT8U value)
{
	INT8U data[2]		=
...
INT32U reg_1byte_data_1byte_read(i2c_bus_handle_t * handle, 
	INT8U reg, 
	INT8U * value)
{
	INT32U ret			= 0;
...
INT32U reg_1byte_data_2byte_write(i2c_bus_handle_t * handle, 
	INT8U reg, 
	INT16U value)
{
	INT8U data[3]		=
...
INT32U reg_1byte_data_2byte_read(i2c_bus_handle_t * handle, 
	INT8U reg, 
	INT16U * value)
{
	INT32U ret			= 0;
...
INT32U reg_2byte_data_1byte_write(i2c_bus_handle_t * handle, 
	INT16U reg, 
	INT8U value)
{
	INT8U data[3]		=
...
INT32U reg_2byte_data_1byte_read(i2c_bus_handle_t * handle, 
	INT16U reg, 
	INT8U * value)
{
	INT32U ret			= 0;
