...
//	Return: 		None
//====================================================================================================
void sccb_init(INT32U nSCL, // Clock Port No
...
//	Note:			Please refer to SCCB spec
//====================================================================================================
void sccb_write(INT16U id, // Slave ID
INT16U addr, // Register Address
INT16U data // Register Data
)
{
...
//	Note:			Please refer to SCCB spec
//====================================================================================================
INT16U sccb_read(INT16U id, // Slave ID
INT16U addr // Register Address
)
{
	INT16U data;
...
//	Return:			None
//====================================================================================================
void OV6680_Init(INT16S nWidthH, // Active H Width
INT16S nWidthV, // Active V Width
INT16U uFlag // Flag Type
)
{
...
//	Return:			None
//====================================================================================================
void OV9655_Init(INT16S nWidthH, // Active H Width
INT16S nWidthV, // Active V Width
INT16U uFlag // Flag Type
)
{
...
//	Return:			None
//====================================================================================================
void OV7680_Init(INT16S nWidthH, // Active H Width
INT16S nWidthV, // Active V Width
INT16U nFlag // Flag Type
)
{
...
//	Return:			None
//====================================================================================================
void OV7670_Init(INT16S nWidthH, // Active H Width
INT16S nWidthV, // Active V Width
INT16U uFlag // Flag Type
)
{
	...
	if (frame_mode_en == 1)
	{ // CSI_MODE == CSI_TG_FRAME_MODE
		R_CSI_TG_CTRL0		= uCtrlReg1 | 0x010000;
	}
	else 
	{ // CSI_MODE == CSI_FIFO_32_MODE
		R_CSI_TG_CTRL0		= uCtrlReg1 | 0x310000;
	}
}
...
//	Return:			None
//====================================================================================================
void OV2643_Init(INT16S nWidthH, // Active H Width
INT16S nWidthV, // Active V Width
INT16U uFlag // Flag Type
)
{
...
//	Return:			None
//====================================================================================================
void OV7725_Init(INT16S nWidthH, // Active H Width
INT16S nWidthV, // Active V Width
INT16U uFlag // Flag Type
)
{
...
//	Return:			None
//====================================================================================================
void OV2655_Init(INT16S nWidthH, // Active H Width
INT16S nWidthV, // Active V Width
INT16U uFlag // Flag Type
)
{
...
//	Return:			None
//====================================================================================================
void OV3640_Init(INT16S nWidthH, // Active H Width
INT16S nWidthV, // Active V Width
INT16U uFlag // Flag Type
)
{
...
//	Return:			None
//====================================================================================================
void OV5642_Init(INT16S nWidthH,				// Active H Width
	INT16S nWidthV, 								// Active V Width
	INT16U uFlag									// Flag Type
)
{
...
//	Return:			None
//====================================================================================================
void OV7675_Init(INT16S nWidthH,				// Active H Width
	INT16S nWidthV, 								// Active V Width
	INT16U uFlag									// Flag Type
)
{
...
//	Return:			None
//====================================================================================================
void GC0308_Init(INT16S nWidthH,				// Active H Width
	INT16S nWidthV, 								// Active V Width
	INT16U uFlag									// Flag Type
)
{
...
//	Return:			None
//====================================================================================================
void SP0838_Init(INT16S nWidthH,				// Active H Width
	INT16S nWidthV, 								// Active V Width
	INT16U uFlag									// Flag Type
)
{
