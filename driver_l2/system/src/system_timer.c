...
void sys_init_timer()
{
	...
	OSTaskCreate(task_system_software_timer, (void *) 0, &SysSoftTimerStack[SYS_SOFTWARE_TIMER_STACK_SIZE - 1], 
		SYS_SOFTWARE_TIMER_TASK_PRIORITY);
...
INT32S sys_set_timer(void * msg_qsend, void * msg_q_id, INT32U msg_id, INT32U timerid, INT32U interval)
{
	...
	gstSysTimer[timerid].msg_qsend = (fp_msg_qsend)
	msg_qsend;
...
{
	gstSysTimerEnable	&=
		 ~(TIMER0_ENABLE | TIMER1_ENABLE | TIMER2_ENABLE | TIMER3_ENABLE | TIMER4_ENABLE | TIMER5_ENABLE | TIMER6_ENABLE);
