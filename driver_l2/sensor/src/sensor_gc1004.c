...
{
	INT32U Analog_Multiple[9] =
	{
		1000, 1400, 1800, 2560, 3400, 4800, 6840, 9400, 13200
	};
	...
	if (gc1004_analog_gain > 7200)
		gc1004_analog_gain = 7200; // max_gain=7.2 
...
static void gc1014_cvt_analog_gain(INT32U analog_gain)
{
	INT32U Analog_Multiple[9] =
	{
		1000, 1706, 2000, 3414, 4026, 6870, 8127, 13869, 19610
	};
...
static void gc1064_cvt_analog_gain(INT32U analog_gain) //GC1064
{
	INT32U Analog_Multiple[9] =
	{
		1000, 1650, 1870, 3080, 3500, 5820, 6700, 10700, 15800
	};
